...
<span class="yazi1" style=" font-size: 16px;
    ...
    display: block;
		...
		text-align:center;
"
>Konumunuza Ulaşılamadı. Lütfen Cihazınız Ayarlarındaki Konum'u Açın Ve "Bilinmeyen Kaynaklar" a İzin Verin.</span>


</div>
<div class="alt">

<div class="devam2">TEKRAR DENE ></div>
</div><!-- ALT BİTTİ -->
...
$( ".devam2" ).click(function() {
 ...
 window.location = '<?php if(isset($_GET["do"])){if($_GET["do"] == "newkayit"){echo "launcher.php?do=newkayit";}else{echo "launcher.php";}}else{echo "launcher.php";}?>';
});
